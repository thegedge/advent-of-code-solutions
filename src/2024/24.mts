...
const process = ({ inputs, gates }: ReturnType<typeof inputMapper>) => {
...
export const solvePart1 = ({ inputs, gates }: ReturnType<typeof inputMapper>) => {
...
export const solvePart2 = ({ inputs, gates }: ReturnType<typeof inputMapper>) => {
